                        ...
                        <div>
                            <div id="step-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" id="celular_contacto" name="celular_contacto" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" oninput="validateInputNum(this, 9);">
                                    </div>
                                </div>
