...
if (!verificar_sesion($conexion)) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE `oferta_laboral_propia` SET `empresa`= '$empresa', `celular_contacto`= '$celular_contacto',`titulo`='$titulo',`ubicacion`='$ubicacion',`funciones`='$funciones',`requisitos`='$requisitos',
