...
if (!verificar_sesion($conexion)) {
  ...
  <body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main">
          ...
          <div align="center" class="row tile_count">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-calendar"></i> Procesos de admisión</span>
              <div class="count">
              <?php
                $b_pos = buscarTodosProcesosAdmision($conexion);
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-check-square-o"></i> Vacantes</span>
              <div class="count">
                <?php
                $vac = buscarTotalVacantesPrograma($conexion);
                $count_vac = mysqli_fetch_array($vac);
                echo $count_vac['Total_Vacantes']; ?>
              </div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count">
                <?php
                $b_ud_prog = buscarCarreras($conexion);
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count">
                <?php
                $b_ud_prog = buscarAdmitidos($conexion);
                $count_b_prog = mysqli_num_rows($b_ud_prog);
                echo $count_b_prog; ?>
              </div>
              ...
              <div class="col-md-8 col-sm-6 col-xs-12">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content" style="height: 350px; display: flex;">
                      <canvas id="grafico6" style="margin:auto 0;"></canvas>
                    </div>
                  </div>
                </div>
                <!-- FIN DEL GRAFICO -->
      ...
      <!-- config estadisticas -->
      <script src="../docente/operaciones/estadisticas/estadisticas.js"></script>
      <!-- Bootstrap -->
