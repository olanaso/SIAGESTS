...
if (!verificar_sesion($conexion)) {
  ...
  <head>
    ...
    <!--<script src="../showdownjs/dist/showdown.min.js"></script>-->
    <!-- Incluye el script de Showdown -->
    ...
    <style>
      .card {
        ...
        height: 350px;
        /* Ajustar la altura de todas las tarjetas */
        display: flex;
  ...
  <body class="nav-md">
    ...
    <script>
      ...
      const mddiv = document.querySelector('#markdownContent');

      // Cargar el contenido del archivo Markdown
      fetch('../include/markdowns/contenido_coordinador.md')
