...
function pintarGrafico1() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_mediosDifusion.php",
        success: function (r) {
...
function pintarGrafico2() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_programaEstudios.php",
        success: function (r) {
...
function pintarGrafico3() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_modalidades.php",
        success: function (r) {
...
function pintarGrafico4() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_mediosPago.php",
        success: function (r) {
...
function pintarGrafico5() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_colegios.php",
        success: function (r) {
...
// GRAFICO 6 - MEDIOS DE DIFUSION

function pintarGrafico6() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_procesoAdmision.php",
        success: function (r) {
            ...
            ctxLine = document.getElementById('grafico6').getContext('2d');
            ...
            const myChart6 = new Chart(ctxLine, config);
        }
    });
}
// GRAFICO 7 - GENERO
...
function pintarGrafico7() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_genero.php",
        success: function (r) {
...
function pintarGrafico8() {
    $.ajax({
        type: "POST",
        url: "operaciones/estadisticas/obtener_postulantes_edades.php",
        success: function (r) {
